	...
	def _check_invoice_reference(self):
		for invoice in self:
			...
			if invoice.type in ('in_invoice', 'in_refund') and invoice.reference:
				if self.search([('type','=',invoice.type),('it_type_document','=',invoice.it_type_document.id),('type', '=', invoice.type), ('reference', '=', invoice.reference),('state','not in',('draf','cancel')),('company_id', '=', invoice.company_id.id), ('partner_id', '=', invoice.partner_id.id), ('id', '!=', invoice.id)]):
