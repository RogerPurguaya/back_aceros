...
class account_asset_analisis_depreciacion(models.Model):
    ...
    def init(self):
        self.env.cr.execute(""" 
            ...
            SELECT row_number() OVER () AS id,* from (
            select aaa.name as activofijo,aadl.sequence as mes,ap.name as periodo, aadl.depreciated_value as depreciacion, aac.name as categoria, aa_gasto.code as cta_gasto, aa_depreciacion.code as cta_depre, analytic_account.name as cta_analitica, Null::integer as distrib_analitica,
