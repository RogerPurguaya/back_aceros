...
class account_invoice(models.Model):
	...
	def anular_action_factura_it(self):
		print self.residual, self.amount_total,"%.2f"%self.residual != "%.2f"%self.amount_total, self.residual == self.amount_total
		...
		print lines,'esta son las lineas', lines[0].read()
