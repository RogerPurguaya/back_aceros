...
class account_bank_statement(models.Model):
    ...
    def generate_excel(self):
        ...
        print "start: " ,self.balance_start
        print "end_real: " ,self.balance_end_real
        print "journal", self.journal_id[0]
        print "journal", self.journal_id[0].id
        print "journal", self.journal_id[0].name
        ...
        for item in self.line_ids:
            print "partner", item.partner_id.name
            print "medio pago" , item.medio_pago.name
